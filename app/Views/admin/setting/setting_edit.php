            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card card-rounded">
                    ...
                    <form autocomplete="off" action="<?=base_url('/admin/setting') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <h4 class="py-2 text-danger">Setting for website front panel</h4>
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="btn btn-success waves-effect waves-light m-r-3">Update</button>
                        <?php } ?>
                        <!--<button type="reset" class="btn btn-primary waves-effect waves-light m-r-3">Reset</button>-->
                        <a href="<?=base_url('/admin') ?>" class="btn btn-warning waves-effect waves-light m-r-3" role="button">Back</a>
                    </form>
                    </div>
                </div>
            </div>
