...
<head>
  ...
  <link href="<?php echo base_url('public/assets/images/logo.png'); ?>" rel="icon">
  <title>myGateway</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                ...
                <div class="copyright text-center my-auto">
                    ...
                    <b><a href="https://webpanelsolutions.com/" target="_blank">webpanelsolution</a></b>
                    </span>
                </div>
                </div>
            </footer>
