...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url('public/assets/Admin/vendors/datatables.net-bs4/dataTables.bootstrap4.css') ?>">
  <link rel="stylesheet" href="<?=base_url('public/assets/Admin/js/select.dataTables.min.css') ?>">
  <link rel="stylesheet" href="<?=base_url('public/assets/Admin/vendors/select2/select2.min.css') ?>">
  <link rel="stylesheet" href="<?=base_url('public/assets/Admin/vendors/select2-bootstrap-theme/select2-bootstrap.min.css') ?>">
...
<body>
  ...
  <script src="<?=base_url('public/assets/Admin/vendors/progressbar.js/progressbar.min.js') ?>"></script>
  <script src="<?=base_url('public/assets/Admin/vendors/typeahead.js/typeahead.bundle.min.js') ?>"></script>
  <script src="<?=base_url('public/assets/Admin/vendors/select2/select2.min.js') ?>"></script>
  <script src="<?=base_url('public/assets/Admin/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js') ?>"></script>
  ...
  <script src="<?=base_url('public/assets/Admin/js/dashboard.js') ?>"></script>
  <script src="<?=base_url('public/assets/Admin/js/Chart.roundedBarCharts.js') ?>"></script>
  <script src="<?=base_url('public/assets/Admin/js/file-upload.js') ?>"></script>
