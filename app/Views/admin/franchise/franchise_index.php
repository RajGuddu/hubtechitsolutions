                ...
                <div class="card card-rounded">
                    <div class="card-body">
                        <div class="d-sm-flex justify-content-between align-items-start">
                            <div>
                                <h4 class="card-title card-title-dash">Centers List</h4>
                                <!-- <p class="card-subtitle card-subtitle-dash">You have 50+ new requests</p> -->
                            </div>
                            <?php if(is_privilege(19,2)){ ?>
                            <div>
                                <a href="<?=base_url('admin/center_cu')?>" class="btn btn-primary btn-sm text-white mb-0 me-0" role="button"> Add New Center</a>
                            </div>
                            <?php } ?>
                        </div>
                        <?php /*
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <a href="<?= base_url('/admin/center_cu/'.$list->fra_id) ?>" class="btn btn-outline-primary" role="button" title="Edit"><i class="fas fa-edit"></i></a>
                                                <?php } ?>
